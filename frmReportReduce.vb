                    ...
                    If qResult(0).ToString.Trim.ToUpper = "SUCCESS" Then
                        If dtResult.Tables("Jobs").Rows.Count > 0 Then
                            For i As Integer = 0 To dtResult.Tables("Jobs").Rows.Count - 1
                                ...
                                .Cells(.RowCount - 1, 6).Text = dtResult.Tables("Jobs").Rows(i)("πÈ”Àπ—° Ëß≈¥√Ÿ")
                                .Cells(.RowCount - 1, 7).Text = dtResult.Tables("Jobs").Rows(i)("πÈ”Àπ—°Roll")
                                .Cells(.RowCount - 1, 8).Text = dtResult.Tables("Jobs").Rows(i)("πÈ”Àπ—°√«¡")
                                .Cells(.RowCount - 1, 9).Text = dtResult.Tables("Jobs").Rows(i)("πÈ”Àπ—°Roll≈«¥")
                                .Cells(.RowCount - 1, 10).Text = dtResult.Tables("Jobs").Rows(i)(" √ÿªÀ“¬")
                            Next
                        End If
                    End If
                End If
