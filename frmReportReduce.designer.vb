...
Partial Class frmReportReduce
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmReportReduce))
        ...
        Me.fpSize_Sheet1.ColumnCount = 11
        ...
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "น้ำหนักส่งลดรู"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "น้ำหนักroll"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "รวม"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "roll+ลวด"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "หาย"
        ...
        Me.fpSize_Sheet1.Columns.Get(6).Label = "น้ำหนักส่งลดรู"
        ...
        Me.fpSize_Sheet1.Columns.Get(7).Label = "น้ำหนักroll"
        ...
        Me.fpSize_Sheet1.Columns.Get(9).Label = "roll+ลวด"
        Me.fpSize_Sheet1.Columns.Get(9).Locked = True
        Me.fpSize_Sheet1.Columns.Get(9).Width = 100.0!
        Me.fpSize_Sheet1.Columns.Get(10).Label = "หาย"
