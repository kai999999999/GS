...
Partial Class frmReportSend
    ...
    Private Sub InitializeComponent()
        ...
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "ชื่อคนตัด"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "รหัสตัด"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "น้ำหนักกล้า"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "น้ำหนักห่วง"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "น้ำหนักส่งห่วง"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "ชื่อคนร้อย"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "รหัสส่งร้อย"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 13).Value = "น้ำหนักส่งร้อย"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 14).Value = "วันที่เก็บ"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 15).Value = "น้ำหนักเก็บ"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 16).Value = "เศษห่วง"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 17).Value = "หาย"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 18).Value = "ฟุต"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 19).Value = "ห่วง"
        ...
        Me.fpSize_Sheet1.Columns.Get(6).Label = "ชื่อคนตัด"
        ...
        Me.fpSize_Sheet1.Columns.Get(7).Label = "รหัสตัด"
        Me.fpSize_Sheet1.Columns.Get(7).Locked = True
        Me.fpSize_Sheet1.Columns.Get(7).Width = 106.0!
        Me.fpSize_Sheet1.Columns.Get(8).Label = "น้ำหนักกล้า"
        ...
        Me.fpSize_Sheet1.Columns.Get(19).Label = "ห่วง"
