                    ...
                    If qResult(0).ToString.Trim.ToUpper = "SUCCESS" Then
                        If dtResult.Tables("Jobs").Rows.Count > 0 Then
                            For i As Integer = 0 To dtResult.Tables("Jobs").Rows.Count - 1
                                ...
                                .Cells(.RowCount - 1, 10).Text = dtResult.Tables("Jobs").Rows(i)("Process5")
                                .Cells(.RowCount - 1, 11).Text = dtResult.Tables("Jobs").Rows(i)("Process6")
                                ...
                                .Cells(.RowCount - 1, 14).Text = dtResult.Tables("Jobs").Rows(i)("Timer").ToString.Trim
                            Next
                        End If
                    End If
                End If
