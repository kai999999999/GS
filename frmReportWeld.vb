Public Class frmReportWeld
    ...
    Private Sub Button7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        Try
            With fpSize_Sheet1
                .RowCount = 0
                Sql = "SELECT * FROM [vProcessWeld] WHERE Lot<>''"
                    ...
                    If qResult(0).ToString.Trim.ToUpper = "SUCCESS" Then
                        If dtResult.Tables("Jobs").Rows.Count > 0 Then
                            For i As Integer = 0 To dtResult.Tables("Jobs").Rows.Count - 1
                                ...
                                .Cells(.RowCount - 1, 6).Text = dtResult.Tables("Jobs").Rows(i)("ทอเสร็จ")
                                .Cells(.RowCount - 1, 7).Text = dtResult.Tables("Jobs").Rows(i)("Weave")
                                .Cells(.RowCount - 1, 8).Text = dtResult.Tables("Jobs").Rows(i)("Weld")
                                .Cells(.RowCount - 1, 9).Text = dtResult.Tables("Jobs").Rows(i)("น้ำหนักก่อนต้ม")
                                .Cells(.RowCount - 1, 10).Text = dtResult.Tables("Jobs").Rows(i)("น้ำหนักหลังต้ม")
                                .Cells(.RowCount - 1, 11).Text = dtResult.Tables("Jobs").Rows(i)("หายต้ม")
                                .Cells(.RowCount - 1, 12).Text = dtResult.Tables("Jobs").Rows(i)("ก่อนเชื่อม")
                                .Cells(.RowCount - 1, 13).Text = dtResult.Tables("Jobs").Rows(i)("น้ำประสาน")
                                .Cells(.RowCount - 1, 14).Text = dtResult.Tables("Jobs").Rows(i)("หลังเชื่อม")
                                .Cells(.RowCount - 1, 15).Text = dtResult.Tables("Jobs").Rows(i)("น้ำประสานเกิน")
                                .Cells(.RowCount - 1, 16).Text = dtResult.Tables("Jobs").Rows(i)("เศษ")
                                .Cells(.RowCount - 1, 17).Text = dtResult.Tables("Jobs").Rows(i)("หาย")
                            Next
                        End If
                    End If
                End If
