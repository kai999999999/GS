...
Partial Class frmReportKiln
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmReportKiln))
        ...
        Me.fpSize_Sheet1.ColumnCount = 15
        ...
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "น้ำหนักสร้อย"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "เศษ"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "น้ำหนักรวม"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "รวมหาย"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "สรุปหาย"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "จำนวนเส้น"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 13).Value = "70"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 14).Value = "NO.เตา"
        ...
        Me.Name = "frmReportKiln"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "รายงาน - ลงเตา"
