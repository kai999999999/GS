...
Partial Class frmReportWeld
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmReportWeld))
        ...
        Me.fpSize_Sheet1.ColumnCount = 18
        ...
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "สถานะ"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "น้ำหนักทอเสร็จ"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "รหัสทอ"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "รหัสเชื่อม"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "น้ำหนักก่อนต้ม"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "น้ำหนักหลังต้ม"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "หาย"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "ก่อนเชื่อม"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 13).Value = "น้ำประสาน"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 14).Value = "หลังเชื่อม"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 15).Value = "น้ำประสานเกิน"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 16).Value = "เศษ"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 17).Value = "สรุปหาย"
        ...
        Me.fpSize_Sheet1.Columns.Get(5).Label = "สถานะ"
        ...
        Me.fpSize_Sheet1.Columns.Get(6).CellType = NumberCellType1
        Me.fpSize_Sheet1.Columns.Get(6).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right
        Me.fpSize_Sheet1.Columns.Get(6).Label = "น้ำหนักทอเสร็จ"
        ...
        Me.fpSize_Sheet1.Columns.Get(7).Label = "รหัสทอ"
        Me.fpSize_Sheet1.Columns.Get(7).Locked = True
        Me.fpSize_Sheet1.Columns.Get(7).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center
        ...
        Me.fpSize_Sheet1.Columns.Get(8).Label = "รหัสเชื่อม"
        Me.fpSize_Sheet1.Columns.Get(8).Locked = True
        Me.fpSize_Sheet1.Columns.Get(8).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center
        Me.fpSize_Sheet1.Columns.Get(8).Width = 106.0!
        Me.fpSize_Sheet1.Columns.Get(9).Label = "น้ำหนักก่อนต้ม"
        Me.fpSize_Sheet1.Columns.Get(9).Locked = True
        Me.fpSize_Sheet1.Columns.Get(9).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center
        Me.fpSize_Sheet1.Columns.Get(9).Width = 100.0!
        Me.fpSize_Sheet1.Columns.Get(10).Label = "น้ำหนักหลังต้ม"
        Me.fpSize_Sheet1.Columns.Get(10).Locked = True
        Me.fpSize_Sheet1.Columns.Get(10).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center
        Me.fpSize_Sheet1.Columns.Get(10).Width = 100.0!
        Me.fpSize_Sheet1.Columns.Get(11).Label = "หาย"
        Me.fpSize_Sheet1.Columns.Get(11).Locked = True
        Me.fpSize_Sheet1.Columns.Get(11).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center
        Me.fpSize_Sheet1.Columns.Get(11).Width = 100.0!
        Me.fpSize_Sheet1.Columns.Get(12).Label = "ก่อนเชื่อม"
        Me.fpSize_Sheet1.Columns.Get(12).Locked = True
        Me.fpSize_Sheet1.Columns.Get(12).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center
        Me.fpSize_Sheet1.Columns.Get(12).Width = 100.0!
        Me.fpSize_Sheet1.Columns.Get(13).Label = "น้ำประสาน"
        Me.fpSize_Sheet1.Columns.Get(13).Locked = True
        Me.fpSize_Sheet1.Columns.Get(13).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center
        Me.fpSize_Sheet1.Columns.Get(13).Width = 100.0!
        Me.fpSize_Sheet1.Columns.Get(14).Label = "หลังเชื่อม"
        Me.fpSize_Sheet1.Columns.Get(14).Locked = True
        Me.fpSize_Sheet1.Columns.Get(14).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center
        Me.fpSize_Sheet1.Columns.Get(14).Width = 100.0!
        Me.fpSize_Sheet1.Columns.Get(15).Label = "น้ำประสานเกิน"
        Me.fpSize_Sheet1.Columns.Get(15).Locked = True
        Me.fpSize_Sheet1.Columns.Get(15).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center
        Me.fpSize_Sheet1.Columns.Get(15).Width = 102.0!
        Me.fpSize_Sheet1.Columns.Get(16).Label = "เศษ"
        Me.fpSize_Sheet1.Columns.Get(16).Locked = True
        Me.fpSize_Sheet1.Columns.Get(16).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center
        Me.fpSize_Sheet1.Columns.Get(16).Width = 100.0!
        Me.fpSize_Sheet1.Columns.Get(17).Label = "สรุปหาย"
        Me.fpSize_Sheet1.Columns.Get(17).Locked = True
        Me.fpSize_Sheet1.Columns.Get(17).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center
        ...
        Me.Panel1.Size = New System.Drawing.Size(680, 114)
        Me.Panel1.TabIndex = 42
        '
        'TextBox3
        '
        Me.TextBox3.BackColor = System.Drawing.Color.White
        Me.TextBox3.Location = New System.Drawing.Point(545, 10)
        ...
        Me.Button7.Location = New System.Drawing.Point(538, 45)
        ...
        Me.Label4.Location = New System.Drawing.Point(499, 13)
        ...
        Me.Name = "frmReportWeld"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "รายงาน - เชื่อม"
