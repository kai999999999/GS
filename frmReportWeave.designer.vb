...
Partial Class frmReportWeave
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmReportWeave))
        ...
        Me.fpSize_Sheet1.ColumnCount = 12
        ...
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "น้ำหนักรีดลาย"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "น้ำหนักส่งทอ"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "น้ำหนักroll"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "ทอเสร็จ"
        ...
        Me.fpSize_Sheet1.Columns.Get(6).Label = "น้ำหนักรีดลาย"
