Public Class frmReportCut
    ...
    Private Sub Button7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        Try
            With fpSize_Sheet1
                .RowCount = 0
                Sql = "SELECT * FROM [vProcessCut] WHERE Lot<>''"
                    ...
                    If qResult(0).ToString.Trim.ToUpper = "SUCCESS" Then
                        If dtResult.Tables("Jobs").Rows.Count > 0 Then
                            For i As Integer = 0 To dtResult.Tables("Jobs").Rows.Count - 1
                                ...
                                .Cells(.RowCount - 1, 6).Text = dtResult.Tables("Jobs").Rows(i)("ส่งกล้า")
                                .Cells(.RowCount - 1, 7).Text = dtResult.Tables("Jobs").Rows(i)("Cut")
                                .Cells(.RowCount - 1, 8).Text = dtResult.Tables("Jobs").Rows(i)("น้ำหนักตัด")
                                .Cells(.RowCount - 1, 9).Text = dtResult.Tables("Jobs").Rows(i)("น้ำหนักห่วง")
                                .Cells(.RowCount - 1, 10).Text = dtResult.Tables("Jobs").Rows(i)("รหัสย่อย")
                                .Cells(.RowCount - 1, 11).Text = dtResult.Tables("Jobs").Rows(i)("แบ่ง")
                                .Cells(.RowCount - 1, 12).Text = dtResult.Tables("Jobs").Rows(i)("น้ำหนักเศษห่วง")
                                .Cells(.RowCount - 1, 13).Text = dtResult.Tables("Jobs").Rows(i)("น้ำหนักเศษผง")
                                .Cells(.RowCount - 1, 14).Text = dtResult.Tables("Jobs").Rows(i)("สรุปหาย")
                                .Cells(.RowCount - 1, 15).Text = dtResult.Tables("Jobs").Rows(i)("จำนวนห่วงหาย")
                                .Cells(.RowCount - 1, 16).Text = dtResult.Tables("Jobs").Rows(i)("No").ToString.Trim
                                .Cells(.RowCount - 1, 17).Text = dtResult.Tables("Jobs").Rows(i)("CreateUser").ToString.Trim
                            Next
                        End If
                    End If
                End If
