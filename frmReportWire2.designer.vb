...
Partial Class frmReportWire2
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmReportWire2))
        ...
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "น้ำหนักทอง"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "น้ำหนกทองแดง"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "รวม"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "แนบ"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "เศษทองหาย"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "เศษทอง"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "เศษทองแดง"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 13).Value = "ชักลวด"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 14).Value = "ชักเม็ด"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 15).Value = "เศษหาย"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 16).Value = "รีดลาย"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 17).Value = "เศษทอง"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 18).Value = "เศษทองแดง"
        Me.fpSize_Sheet1.ColumnHeader.Cells.Get(0, 19).Value = "สรุปหาย"
        ...
        DateTimeCellType2.DateDefault = New Date(2019, 10, 8, 21, 8, 31, 0)
        ...
        DateTimeCellType2.TimeDefault = New Date(2019, 10, 8, 21, 8, 31, 0)
        DateTimeCellType2.UserDefinedFormat = "dd/MM/yyyy HH:mm:ss"
        Me.fpSize_Sheet1.Columns.Get(0).CellType = DateTimeCellType2
        ...
        Me.fpSize_Sheet1.Columns.Get(1).CellType = TextCellType4
        ...
        Me.fpSize_Sheet1.Columns.Get(2).CellType = TextCellType5
        ...
        Me.fpSize_Sheet1.Columns.Get(4).CellType = TextCellType6
        ...
        Me.fpSize_Sheet1.Columns.Get(6).CellType = NumberCellType2
        Me.fpSize_Sheet1.Columns.Get(6).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right
        Me.fpSize_Sheet1.Columns.Get(6).Label = "น้ำหนักทอง"
        ...
        Me.Name = "frmReportWire2"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "รายงาน - ชักลวดทอ"
